...
namespace BricksGame
{
    public class Ball
    {
        public BALLDATA m_tBall = new BALLDATA();
        Bar m_pBar;
        Block m_pBlock;
        ...
        public void SetBlock(Block pBlock) { m_pBlock = pBlock; }
        ...
        public int Collision(int x, int y)
        {
            ...
            //Bar충돌처리
            if (x >= m_pBar.m_tBar.nX[0] && x <= m_pBar.m_tBar.nX[2] + 1 && y == (m_pBar.m_tBar.nY)) //바 위 충돌
            {
            ...
            if (x >= m_pBar.m_tBar.nX[0] && x <= m_pBar.m_tBar.nX[2] + 1 && y == (m_pBar.m_tBar.nY + 1)) //바 아래 충돌
            {
                if (m_tBall.nDirect == 1)
                    m_tBall.nDirect = 2;
                else if (m_tBall.nDirect == 2)
            ...
            for(int i = 0; i<20; i++)
            {
                if (m_pBlock.m_tBlock[i].Exist == true)
                {
                    if(x >= m_pBlock.m_tBlock[i].nX && x<= m_pBlock.m_tBlock[i].nX +1 && y == m_pBlock.m_tBlock[i].nY)
                    {
                        if (m_tBall.nDirect == 1)
                            m_tBall.nDirect = 2;
                        else if (m_tBall.nDirect == 2)
                        ...
                        m_pBlock.m_tBlock[i].Exist = false;

                        return 1;
                    }

                    if(x >= m_pBlock.m_tBlock[i].nX && x<= m_pBlock.m_tBlock[i].nX + 1 && y == m_pBlock.m_tBlock[i].nY +1)
                    {
                        if (m_tBall.nDirect == 1)
                            m_tBall.nDirect = 2;
                        else if (m_tBall.nDirect == 2)
        ...
        {
            m_tBall.nReady = 0; //공 안움직임1 움직임 0
            m_tBall.nDirect = 1;
            m_tBall.nX = 30;
            m_tBall.nY = 10;
